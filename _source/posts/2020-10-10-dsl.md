...
[imperative language]: https://rosettacode.org/wiki/Category:Programming_paradigm/Imperative
[Kotlin]: https://kotlinlang.org/
[object-oriented]: https://www.amazon.com/gp/product/0136291554/
[Scala]: https://www.scala-lang.org/
[Xtend]: https://www.eclipse.org/xtend/

:right ![Scala][image]

:first Some days ago I wrote an post about DSL, but it was so sloppy, that I’ve
found myself in shame. ’Cause that, I’m removing that post and replacing it with
this.

When I started working with [Scala][], I did it all wrong. I learned Scala from
^^abbr(title="Java programmers") *oakies* ^^, so my team used Scala just as a
syntax sugar for Java (like [Kotlin][] or [Xtend][]).
...
Both languages are [object-oriented][], but Java is an [imperative language][] in
the most strict sense, while Scala is impure [functional][], tending tightly to
the pureness.
...
for specific domains, called [domain-specific languages][], or just **DSL** –
